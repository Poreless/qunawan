...
<head>
	...
	<link type="text/css" rel="stylesheet"
		href="${pageContext.request.contextPath}/css/personalCss.css" />
	<link rel="stylesheet"
		href="${pageContext.request.contextPath}/css/jquery.Jcrop.min.css">
	<link rel="stylesheet" type="text/css"
		href="${pageContext.request.contextPath}/css/img_account.css">
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/jquery/jquery-1.11.0.min.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/bootstrap/bootstrap.min.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/pages/personal/frame/jquery.Jcrop.min.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/pages/personal/frame/birthday.js"></script>
	<script src="${pageContext.request.contextPath}/js/common.js"
		type="text/javascript"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/pages/personal/personal_information.js"></script>
	<script type="text/javascript">
								...
								onBlur="checkSelect()">
									<c:choose>
										<c:when test="${!empty user.city }">
											<option value='${user.city.city.id}'>${user.city.city.name}</option>
										</c:when>
										<c:otherwise>
									...
									<c:forEach items="${provinces}" var="province">
										...
										${city.city.id==province.id?'selected':''}>${province.name}</option>
									</c:forEach>
							</select> 
							<select id="select_city" name="user.city.id" class="city cityclass"
